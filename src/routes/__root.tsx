...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GasFlow Pro — Gas Cylinder Plant Management" },
      ...
      { property: "og:title", content: "GasFlow Pro — Gas Cylinder Plant Management" },
      ...
      { name: "twitter:title", content: "GasFlow Pro — Gas Cylinder Plant Management" },
